...
Pull requests containing any of these elements will be prevented from merging to the code base and are likely to be closed.
...
| **Inappropriate language, comments or references found within source or content** | Cool artwork (especially ASCII) is welcome as long as it does not detract from legibility and does not impact overall package size. **All**  content published to this repository (source or otherwise) must follow the [Code of Conduct](https://github.com/CrowdStrike/falconpy/blob/ver_1.0.0/CODE_OF_CONDUCT.md). |
| **Intellectual property that is not yours** | Copywrited works, trademarks, source code or image assets belonging to others should not be posted to this repository whatsoever. CrowdStrike assets which are already released into the Public Domain will be accepted as long as their usage meets other restrictions, the [Code of Conduct](https://github.com/CrowdStrike/falconpy/blob/ver_1.0.0/CODE_OF_CONDUCT.md) and the [CrowdStrike Brand Guide](https://crowdstrikebrand.com/brand-guide/). |
